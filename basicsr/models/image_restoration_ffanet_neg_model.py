...
class ImageRestorationModel_FFANet_Neg_Multi(SRNegModel_Multi):
    """Base Deblur model for single image deblur."""

    def __init__(self, opt):
        super(ImageRestorationModel_FFANet_Neg_Multi, self).__init__(opt)
        ...
        for metric, value in metric_dict.items():
            ...
            if tb_logger is not None:
                tb_logger.add_scalar(
                    f'train/loss/{metric}', value, current_iter)
